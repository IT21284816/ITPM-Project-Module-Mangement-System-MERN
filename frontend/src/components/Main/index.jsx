...
const Main = () => {
  ...
  const handleGoRepMarks = () => {
    navigate('/reportmarks'); // Redirect to the home page
  };
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      <Header/>
      <h1 className='text-center' style={{marginTop:'20px'}}>Student Profile</h1>
      <br></br>
      <hr></hr>
      {/* Main content area */}
      <div className={`container`} style={{flex: '1', marginTop:'50px'}}> {/* Added spacing at the top */}
        ...
        <button className="btn btn-success d-block mx-auto mb-3" onClick={handleGoRepMarks}><FaFileAlt  /> &nbsp; &nbsp;Report Marks
        </button>
        <button className="btn btn-info d-block mx-auto mt-5 mb-3" onClick={handleGoContact}><FaEnvelope   /> &nbsp; &nbsp;Contact Us
        </button>
