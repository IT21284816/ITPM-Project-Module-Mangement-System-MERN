...
const ContactUs = () => {
  ...
  useEffect(() => {
    const fetchContactList = async () => {
        try {
          ...
          const option1Contacts = response.data.filter(contact => contact.selection === 'Examiner');
  ...
  return (
    ...
    <div className="container mt-4" style={{flex: '1'}}>
      ...
      <h3 style={{ backgroundColor: '#F0E68C', padding: '15px' }}>Contact Us - Examiner</h3>
      <br></br><br></br>
      <div className="row">
          ...
          <div key={index} className="col-md-4 mb-4">
            <Card className="h-100 contact-card">
              <Card.Body>
                ...
                <div>
                  <td>
                    <th><Link to={`/contactUsviewexam/${contact._id}`}>
      ...
      <Link className='btn btn-primary mt-5 mb-2' to="/examiner-home">Back to Home</Link>
    </div>
