...
const ContactUs = () => {
  ...
  useEffect(() => {
    const fetchContactList = async () => {
        try {
          ...
          const option1Contacts = response.data.filter(contact => contact.selection === 'Project-Manager');
  ...
  return (
    ...
    <div className="container mt-4">
      ...
      <h3>Contact Us - Project Manager</h3>
      <br></br><br></br>
      <div className="row">
          ...
          <div key={index} className="col-md-4 mb-4">
            <Card className="h-100 contact-card">
              <Card.Body>
                ...
                <div>
                  <td>
                    <th><Link to={`/contactUsviewpm/${contact._id}`}>
